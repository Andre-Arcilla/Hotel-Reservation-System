<?php
    ...
    // 1. Prepare and execute the SQL query to select everything from the reservations table
    $stmt = $pdo->query("SELECT * FROM reservations ORDER BY id DESC");

    // 2. Fetch all rows into the $items variable as an associative array
    ...
    <head>
        ...
        <style>
            ...
            *{margin:0;padding:0;box-sizing:border-box;}
            ...
            .modal{background:#fff;border-radius:var(--radius-lg);padding:28px;width:auto;max-width:95vw;max-height:90vh;overflow-y:auto;box-shadow:0 20px 60px rgba(26,26,46,0.2);transform:translateY(16px) scale(0.97);transition:transform 0.28s cubic-bezier(.4,0,.2,1);}
                    ...
                    <div class="acc-item" id="acc-regency">
                        <div class="acc-header" onclick="toggleAcc('acc-regency')">
                            <div class="acc-left">
                                ...
                                <div><div class="list-name">Regency</div><div class="list-meta"><!-- 8 rooms · -->₱2,500 - ₱3,000/day</div></div>
                            </div>
                            <div class="acc-right">
                        ...
                        <div class="acc-body"><div class="acc-inner">
                            <div class="detail-grid">
                                <div class="detail-field"><label>Room Type</label><p>Regency</p></div>
                                <!-- <div class="detail-field"><label>Floor</label><p>2nd – 3rd Floor</p></div> -->
                                <div class="detail-field"><label>Rate per day</label><p>₱2,500 - ₱3,000</p></div>
                    ...
                    <div class="acc-item" id="acc-deluxe">
                        <div class="acc-header" onclick="toggleAcc('acc-deluxe')">
                            <div class="acc-left">
                                ...
                                <div><div class="list-name">Deluxe</div><div class="list-meta"><!-- 12 rooms · -->₱3,500 - ₱5,000/day</div></div>
                            </div>
                            <div class="acc-right">
                        ...
                        <div class="acc-body"><div class="acc-inner">
                            <div class="detail-grid">
                                <div class="detail-field"><label>Room Type</label><p>Deluxe</p></div>
                                <!-- <div class="detail-field"><label>Floor</label><p>4th – 6th Floor</p></div> -->
                                <div class="detail-field"><label>Rate per day</label><p>₱3,500 - ₱5,000</p></div>
                    ...
                    <div class="acc-item" id="acc-premium">
                        <div class="acc-header" onclick="toggleAcc('acc-premium')">
                            <div class="acc-left">
                                ...
                                <div><div class="list-name">Premium</div><div class="list-meta"><!-- 6 rooms · -->₱5,000 - ₱7,000/day</div></div>
                            </div>
                            <div class="acc-right">
                        ...
                        <div class="acc-body"><div class="acc-inner">
                            <div class="detail-grid">
                                <div class="detail-field"><label>Room Type</label><p>Premium</p></div>
                                <!-- <div class="detail-field"><label>Floor</label><p>7th – 8th Floor</p></div> -->
                                <div class="detail-field"><label>Rate per day</label><p>₱5,000 - ₱7,000</p></div>
                    ...
                    <?php foreach ($items as $item): ?>
                        <div class="acc-item" id="acc-<?php echo $item['id']; ?>">
                            <div class="acc-header" onclick="toggleAcc('acc-<?php echo $item['id']; ?>')">
                                <div class="acc-left">
                                    <div class="list-avatar av-amber">
                                        <?php
                                            ...
                                            $lastInitial = substr(end($words), 0, 1);
                                ...
                                <div class="acc-right">
                                    <span class="list-badge badge-<?= $item['status'] ?>"><?= ucfirst($item['status']) ?></span>
                                    <i class="fa-solid fa-chevron-down acc-chevron"></i>
                                </div>
                            </div>
                            <div class="acc-body"><div class="acc-inner">
                                <div class="detail-grid">
                                    ...
                                    <div class="detail-field"><label>Duration</label><p><?php echo date_diff(date_create($item['checkin_date']), date_create($item['checkout_date']))->format("%a night/s"); ?></p></div>
                                    ...
                                    <div class="detail-field"><label>Total Amount</label><p style="color:var(--red);font-weight:700;"><?php echo $item['total_bill']; ?></p></div>
        ...
        <div class="modal-overlay" id="modal-add-booking" onclick="closeOnOverlay(event,'modal-add-booking')">
            <div class="modal">
                ...
                <form id="bookingForm" action="admin_submit.php" method="POST">
                    <div class="form-row">
                        <div class="form-group"><label>First Name</label><input class="form-input" type="text" placeholder="First Name" name="first_name"></div>
                        <div class="form-group"><label>Last Name</label><input class="form-input" type="text" placeholder="Last Name" name="last_name"></div>
                    ...
                    <div class="form-row">
                        <div class="form-group"><label>Contact Number</label><input class="form-input" type="text" placeholder="Contact Number" name="contact"></div>
                        <div class="form-group"><label>Email</label><input class="form-input" type="text" placeholder="Email" name="email"></div>
                        <div class="form-group"><label>Room Capacity</label>
                            <select class="form-input" name="room_capacity">
                    ...
                    <div class="form-row">
                        <div class="form-group"><label>Check-in Date</label><input class="form-input" type="date" name="checkin_date"></div>
                        <div class="form-group"><label>Check-out Date</label><input class="form-input" type="date" name="checkout_date"></div>
        ...
        <script>
            ...
            function confirmDelete(id) {
                if (confirm("Are you sure you want to delete this booking? This action cannot be undone.")) {
                    // Redirect to the delete script with the specific ID
                    window.location.href = 'admin_delete.php?id=' + id;
                }
            }

            function updateStatus(id, newStatus) {
                // Send the data to the server without leaving the page
                ...
                .then(data => {
                    // Refresh the page so the badge in the accordion header updates visually
